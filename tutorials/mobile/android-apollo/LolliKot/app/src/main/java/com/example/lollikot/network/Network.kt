...
import com.example.lollikot.type.CustomType
...
private val GRAPHQL_ENDPOINT: String = "https://api.lpp.pw/v1/graphql"
private val GRAPHQL_WEBSOCKET_ENDPOINT: String = "wss://api.lpp.pw/v1/graphql"

private val SQL_CACHE_NAME = "cache"
    ...
    fun setApolloClient(accessTokenId: String, context: Context){
        ...
        val okHttpClient = OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                builder.header("lollipop-auth", authHeader)
        ...
        val cacheKeyResolver: CacheKeyResolver = object : CacheKeyResolver() {
            override fun fromFieldRecordSet(field: ResponseField, recordSet: Map<String, Any>): CacheKey {
                if (recordSet.containsKey("")) {
                    val id = recordSet[""] as String
